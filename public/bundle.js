...
var _OptionModal = __webpack_require__(28);
...
var IndcisionApp = function (_Component) {
  _inherits(IndcisionApp, _Component);

  function IndcisionApp() {
    var _ref;

    var _temp, _this, _ret;

    _classCallCheck(this, IndcisionApp);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = IndcisionApp.__proto__ || Object.getPrototypeOf(IndcisionApp)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      options: [],
      selectedOption: undefined
    }, _this.handleAddOption = function (text) {
      if (!text) {
        return 'Please enter valid text';
      } else if (_this.state.options.includes(text)) {
    ...
    }, _this.handleChoiceOption = function () {
    ...
    }, _this.handleRemoveOption = function (optionText) {
      _this.setState(function (prevState) {
        return {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'container' },
          _react2.default.createElement(_Action2.default, { hasOptions: this.state.options.length > 0, handleChoiceOption: this.handleChoiceOption }),
          _react2.default.createElement(
            'div',
            { className: 'widget' },
        ...
        _react2.default.createElement(_OptionModal2.default, { closeModal: this.closeModal, selectedOption: this.state.selectedOption })
      );
    }
  }]);
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      "button",
      {
        ...
        onClick: props.handleChoiceOption
      },
      "What should I do?"
    )
  );
...
var AddOpton = function (_Component) {
  _inherits(AddOpton, _Component);
  ...
  function AddOpton() {
    ...
    _classCallCheck(this, AddOpton);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AddOpton.__proto__ || Object.getPrototypeOf(AddOpton)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      error: undefined
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', { className: 'add-option__input', type: 'text', name: 'optionText' }),
          _react2.default.createElement(
            'button',
            { className: 'button' },
            'Add Option'
...
var OptionModal = function OptionModal(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'button',
      { className: 'button', onClick: props.closeModal },
      'Okay'
    )
  );
};
...
var _ModalPortal = __webpack_require__(33);

var _ModalPortal2 = _interopRequireDefault(_ModalPortal);

var _ariaAppHider = __webpack_require__(37);
...
var _focusManager = __webpack_require__(34);
...
var _tabbable = __webpack_require__(35);
